...
\begin{figure}[H]
	\centering
	\includegraphics[width=.99\textwidth]{software/gazebo-ros-integration}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.79\textwidth]{software/pcl-dependency-graph}
