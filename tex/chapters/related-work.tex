...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{grippers/adaptive-2-finger-gripper-robotiq}
...
\end{figure}
\footnotetext{\url{http://blog.robotiq.com/bid/52886/Industrial-robots-5-most-popular-applications}}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{grippers/adaptive-3-finger-gripper-robotiq}
...
\end{figure}
\footnotetext{\url{http://robotiq.com/products/industrial-robot-hand/}}

\begin{figure}[H]
	\begin{floatrow}[3]
		\ffigbox[1.0\FBwidth]
		{\includegraphics[height=.17\textheight]{grippers/schunk-svh}}
		{\caption[Schunk SVH hand]{Schunk SVH hand\protect\footnotemark}\label{fig:schunk-svh}}
		\ffigbox[1.03\FBwidth]
		...
		\ffigbox[1.03\FBwidth]
		{\includegraphics[height=.17\textheight]{grippers/schunk-svh-power-grip}}
		{\caption[Schunk SVH power grip]{Schunk SVH power grip\protect\footnotemark[\value{footnote}]}\label{fig:schunk-svh-power-grip}}
	\end{floatrow}
\end{figure}
\footnotetext[\value{footnote}]{\url{http://mobile.schunk-microsite.com/en/produkte/products/servo-electric-5-finger-gripping-hand-svh.html1}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{tool-changer}
