...
\begin{figure}[H]
	...
	\caption[Automatic tool changer with 20 different end robotic arm end effectors]{Automatic tool changer with 20 different end robotic arm end effectors\protect\footnotemark}
...
\begin{figure}[H]
	\begin{floatrow}[2]
		...
		{\caption[Vacuum formed packaging trays]{Vacuum formed packaging trays\protect\footnotemark}\label{fig:vacuum-formed-packaging-trays}}
