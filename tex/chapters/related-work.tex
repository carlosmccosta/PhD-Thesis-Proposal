...
\begin{figure}[H]
	\centering
	\includegraphics[width=.75\textwidth]{software/pcl-dependency-graph}
...
During the RoboEarth\footnote{\url{http://roboearth.org/}} project it was developed a set o modular software components that enabled robots to share reusable knowledge and offload heavy computation tasks to the cloud. In \cref{fig:robo-earth-software-overview} it is given a brief overview of the main software modules of the RoboEarth project that will be presented in the next sections.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.63\linewidth]{software/robo-earth-software-overview}
	\caption[Overview of the RoboEarth main software modules]{Overview of the RoboEarth main software modules\protect\footnotemark}
	\label{fig:robo-earth-software-overview}
\end{figure}
...
The KnowRob\footnote{\url{http://www.knowrob.org/}} \cite{Tenorth2013k} is a knowledge processing framework that combines world representation using ontologies with a reasoning engine in order to semantic learn new reusable skills from different data sources.
...
FF\footnote{\url{http://www.cram-system.org/cram}}
...
\begin{wrapfigure}{r}{0.23\textwidth}
	\centering
	\vspace*{-2em}
	\includegraphics*[width=0.8\textwidth]{software/open-cyc-logo}
...
\begin{wrapfigure}{r}{0.23\textwidth}
	\centering
	\vspace*{-2em}
	\includegraphics*[width=0.8\textwidth]{software/orocos-logo}
...
FF \footnote{\url{http://www.roboticslibrary.org/}}
...
\begin{wrapfigure}{r}{0.23\textwidth}
	\centering
	\vspace*{-2em}
	\includegraphics*[width=0.99\textwidth]{software/robodk-logo}
	\caption{RoboDK logo}
