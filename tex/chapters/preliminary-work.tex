...
\begin{figure}[H]
	\begin{floatrow}[2]
		...
		{\caption{Single chip \glsentrytext{dlp} diagram\protect\footnotemark}\label{fig:dlp-projector-diagram-1-dmd}}
		\ffigbox[\FBwidth]
...
\begin{figure}[H]
	\begin{floatrow}[2]
		...
		{\caption{Projection of the \glsentrytext{ilda} calibration pattern\protect\footnotemark}\label{fig:laser-ilda-calibration-pattern-projected}}
	\end{floatrow}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{preliminary-work/chess-board-detection}
